        ...
        <div class="container">
            <div class="row">
                <div class="page-header">
                  <h1>Registro de usuarios <small class="tittles-pages-logo">BUAP SHOP</small></h1>
                </div>
                <div class="col-xs-12 col-sm-6 text-center">
                   <br><br><br>
                    <p><i class="fa fa-users fa-5x"></i></p>
                    <p class="lead">
                        Al registrarse seras parte de la comunidad BUAP.
                    </p>
                    <br>
                    <img src="assets/img/img-registro.png" alt="electrodomesticos" class="img-responsive">
                </div>
